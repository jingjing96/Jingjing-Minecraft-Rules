...
* 当苦力怕在下界被骷髅、流浪者、凋灵骷髅杀死时，有概率掉落所有种类的音乐唱片，包括otherside和Pigstep；
...
* 给闪长岩、花岗岩、安山岩、砂土额外的合成表；
* 用营火烤树苗可以获得枯萎的灌木；
* 烧制闪长岩可以获得方解石，烧制安山岩可以获得凝灰岩；
* 烧制树苗可以获得枯萎的灌木；
* 烧制下界疣块或诡异疣块可以获得下界岩；
* 烧制腐肉可以获得皮革；
* 烧制灵魂沙可以获得灵魂土；
* 给一些原版不可合成的物品添加了合成表，包括：鞍、蜘蛛网、命名牌、草方块、缠根泥土、凋零玫瑰、钟、附魔金苹果、海洋之心、不死图腾、龙头、鞘翅；
* 给收纳袋添加了合成表；
* 给黏土添加了增产的合成表；
* 给西瓜和蜜脾添加了分解的合成表；
* 给高草和大型蕨添加了合成表；
